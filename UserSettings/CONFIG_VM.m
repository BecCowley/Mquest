...
UNIQUE_ID_PATH_UNIX='/media/sf_Mquest/Mquest/';

    MAP_FILE_UNIX='/media/sf_Mquest/Mquest/terrainbase';

    CLIMATOLOGY_PATH_UNIX='/media/sf_Mquest/Mquest/CARSatlas/';
%     LEVITUSDATA_PATH_UNIX='/media/sf_Mquest/CARSatlas/levitusdata/';

    MQUEST_DIRECTORY_UNIX='/media/sf_Mquest/Mquest';
