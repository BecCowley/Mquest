...
profiledata_updated.woce_time = str2double([wt(1:2) wt(4:5) wt(7:8)]);
ti = datenum([wd wt(1:2) wt(4:5) wt(7:8)],'yyyymmddHHMMSS') - datenum('1900-01-01 00:00:00');
profiledata_updated.time = ti;
