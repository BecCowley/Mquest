...
if(ispc)
    clim_fname=[CLIMATOLOGY_PATH_PC 'temperature_cars2009a.nc'];
    clim_fname2=[CLIMATOLOGY_PATH_PC 'temperature_cars2009a.nc'];
else
    clim_fname=[CLIMATOLOGY_PATH_UNIX 'temperature_cars2009a.nc'];
    clim_fname2=[CLIMATOLOGY_PATH_UNIX 'temperature_cars2009a.nc'];
end
